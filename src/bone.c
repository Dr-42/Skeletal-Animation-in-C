...
HeimVec3f interpolate_position(bone_t* bone, float animation_time);
HeimVec4f interpolate_rotation(bone_t* bone, float animation_time);
HeimVec3f interpolate_scaling(bone_t* bone, float animation_time);
